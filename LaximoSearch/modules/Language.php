...
use LaximoSearch\language\LanguageTemplateEn;
use LaximoSearch\language\LanguageTemplateRu;
...
class Language
{
    ...
    public function getLanguageData(string $lang): array
    {
        ...
        if (!array_key_exists($lang, $data)) {
            $currentTemplateClass = 'LaximoSearch\language\LanguageTemplateEn';

            if ($lang) {
                $currentTemplateClass = 'LaximoSearch\language\LanguageTemplate' . ucfirst($lang);
            }
